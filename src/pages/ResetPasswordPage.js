...
//       {/* Titre */}
//       <h1 className="text-3xl font-bold mb-6 text-center">Saisis ton nouveau mot de passe</h1>
...
//   console.log(token);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://back-thumbs.vercel.app/auth/reset-password', {
        token,
        password,
      });
